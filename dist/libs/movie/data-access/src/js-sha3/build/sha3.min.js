 ...
 */ !function() {
    ...
    var r1 = "input is invalid type", n1 = "object" == typeof window, i1 = n1 ? window : {};
    i1.JS_SHA3_NO_WINDOW && (n1 = !1);
    var o1 = !n1 && "object" == typeof self;
    !i1.JS_SHA3_NO_NODE_JS && "object" == typeof process && process.versions && process.versions.node ? i1 = global : o1 && (i1 = self);
    var a1 = !i1.JS_SHA3_NO_COMMON_JS && "object" == typeof module && module.exports, s1 = "function" == typeof define && define.amd, u1 = !i1.JS_SHA3_NO_ARRAY_BUFFER && "undefined" != typeof ArrayBuffer, f1 = "0123456789abcdef".split(""), c1 = [
        4,
        1024,
        262144,
        67108864
    ...
    !i1.JS_SHA3_NO_NODE_JS && Array.isArray || (Array.isArray = function(t) {
        return "[object Array]" === Object.prototype.toString.call(t);
    }), !u1 || !i1.JS_SHA3_NO_ARRAY_BUFFER_IS_VIEW && ArrayBuffer.isView || (ArrayBuffer.isView = function(t) {
        return "object" == typeof t && t.buffer && t.buffer.constructor === ArrayBuffer;
    });
    for(var A1 = function(e, r, n) {
        return function(i) {
            return new t1(e, r, e).update(i)[n]();
        };
    }, w1 = function(e, r, n) {
        return function(i, o) {
            return new t1(e, r, o).update(i)[n]();
        };
    }, v1 = function(t, e2, r) {
        return function(e, n, i, o) {
            return S1["cshake" + t].update(e, n, i, o)[r]();
        };
    }, B1 = function(t, e3, r) {
        return function(e, n, i, o) {
            return S1["kmac" + t].update(e, n, i, o)[r]();
        };
    }, g1 = function(t, e, r, n) {
        ...
        },
        {
            ...
            bits: l1,
            createMethod: function(e4, r) {
                var n2 = w1(e4, r, "hex");
                return n2.create = function(n) {
                    return new t1(e4, r, n);
                }, n2.update = function(t, e) {
                    return n2.create(e).update(t);
                }, g1(n2, w1, e4, r);
            }
        },
        {
            ...
            padding: c1,
            bits: l1,
            createMethod: function(e5, r2) {
                var n3 = b1[e5], i2 = v1(e5, 0, "hex");
                return i2.create = function(i, o, a) {
                    return o || a ? new t1(e5, r2, i).bytepad([
                        o,
                        a
                    ], n3) : S1["shake" + e5].create(i);
                }, i2.update = function(t, e, r, n) {
                    return i2.create(e, r, n).update(t);
                }, g1(i2, v1, e5, r2);
            }
        },
        {
            ...
            padding: c1,
            bits: l1,
            createMethod: function(t2, r3) {
                var n4 = b1[t2], i3 = B1(t2, 0, "hex");
                return i3.create = function(i, o, a) {
                    return new e1(t2, r3, o).bytepad([
                        "KMAC",
                        a
                    ], n4).bytepad([
                        i
                    ], n4);
                }, i3.update = function(t, e, r, n) {
                    return i3.create(t, r, n).update(e);
                }, g1(i3, B1, t2, r3);
            }
        }
    ], S1 = {}, C1 = [], x1 = 0; x1 < k1.length; ++x1)for(var m1 = k1[x1], E1 = m1.bits, O1 = 0; O1 < E1.length; ++O1){
        var z = m1.name + "_" + E1[O1];
        if (C1.push(z), S1[z] = m1.createMethod(E1[O1], m1.padding), "sha3" !== m1.name) {
            var N = m1.name + E1[O1];
            C1.push(N), S1[N] = S1[z];
        }
    }
    t1.prototype.update = function(t) {
        ...
        var e, n = typeof t;
        if ("string" !== n) {
            if ("object" !== n) throw new Error(r1);
            if (null === t) throw new Error(r1);
            if (u1 && t.constructor === ArrayBuffer) t = new Uint8Array(t);
            else if (!(Array.isArray(t) || u1 && ArrayBuffer.isView(t))) throw new Error(r1);
            e = !0;
        }
        for(var i, o, a = this.blocks, s = this.byteCount, f = t.length, c = this.blockCount, p = 0, d = this.s; p < f;){
            ...
            if (e) for(i = this.start; p < f && i < s; ++p)a[i >> 2] |= t[p] << h1[3 & i++];
            else for(i = this.start; p < f && i < s; ++p)(o = t.charCodeAt(p)) < 128 ? a[i >> 2] |= o << h1[3 & i++] : o < 2048 ? (a[i >> 2] |= (192 | o >> 6) << h1[3 & i++], a[i >> 2] |= (128 | 63 & o) << h1[3 & i++]) : o < 55296 || o >= 57344 ? (a[i >> 2] |= (224 | o >> 12) << h1[3 & i++], a[i >> 2] |= (128 | o >> 6 & 63) << h1[3 & i++], a[i >> 2] |= (128 | 63 & o) << h1[3 & i++]) : (o = 65536 + ((1023 & o) << 10 | 1023 & t.charCodeAt(++p)), a[i >> 2] |= (240 | o >> 18) << h1[3 & i++], a[i >> 2] |= (128 | o >> 12 & 63) << h1[3 & i++], a[i >> 2] |= (128 | o >> 6 & 63) << h1[3 & i++], a[i >> 2] |= (128 | 63 & o) << h1[3 & i++]);
    ...
    }, t1.prototype.toString = t1.prototype.hex = function() {
        this.finalize();
        for(var t, e = this.blockCount, r = this.s, n = this.outputBlocks, i = this.extraBytes, o = 0, a = 0, s = ""; a < n;){
            for(o = 0; o < e && a < n; ++o, ++a)t = r[o], s += f1[t >> 4 & 15] + f1[15 & t] + f1[t >> 12 & 15] + f1[t >> 8 & 15] + f1[t >> 20 & 15] + f1[t >> 16 & 15] + f1[t >> 28 & 15] + f1[t >> 24 & 15];
            a % e == 0 && (j1(r), o = 0);
        }
        return i && (t = r[o], s += f1[t >> 4 & 15] + f1[15 & t], i > 1 && (s += f1[t >> 12 & 15] + f1[t >> 8 & 15]), i > 2 && (s += f1[t >> 20 & 15] + f1[t >> 16 & 15])), s;
    }, t1.prototype.arrayBuffer = function() {
        this.finalize();
    ...
    }, t1.prototype.buffer = t1.prototype.arrayBuffer, t1.prototype.digest = t1.prototype.array = function() {
        this.finalize();
    ...
    }, (e1.prototype = new t1).finalize = function() {
        return this.encode(this.outputBits, !0), t1.prototype.finalize.call(this);
    };
    var j1 = function(t) {
