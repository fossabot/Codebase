...
var _methodChooserJs = require("./method-chooser.js");
...
const BroadcastChannel = function(name, options) {
    ...
    this.options = (0, _optionsJs).fillOptionsWithDefaults(options);
    this.method = (0, _methodChooserJs).chooseMethod(this.options);
    // isListening
    this._iL = false;
    /**
     * _onMessageListener
...
function clearNodeFolder(options) {
    options = (0, _optionsJs).fillOptionsWithDefaults(options);
    const method = (0, _methodChooserJs).chooseMethod(options);
    if (method.type === 'node') {
...
BroadcastChannel.prototype = {
    ...
    removeEventListener (type, fn) {
        const obj1 = this._addEL[type].find((obj)=>obj.fn === fn
        );
...
function _prepareChannel(channel) {
    ...
    if ((0, _utilJs).isPromise(maybePromise)) {
