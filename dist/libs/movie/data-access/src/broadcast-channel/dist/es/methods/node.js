...
var _require = require('oblivious-set'), ObliviousSet = _require.ObliviousSet;
/**
...
function _ensureBaseFolderExists() {
    _ensureBaseFolderExists = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee4() {
 ...
 */ function _ensureFoldersExist() {
    _ensureFoldersExist = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee5(channelName, paths) {
        var chmodValue;
            ...
            while(1){
                switch(_context5.prev = _context5.next){
                    ...
                    case 5:
                        _context5.next = 7;
                        return Promise.all([
                            mkdir(paths.readers)["catch"](function() {
                                return null;
                            }),
...
function _clearNodeFolder() {
    _clearNodeFolder = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee6() {
...
function socketPath(channelName, readerUuid, paths) {
    paths = paths || getPaths(channelName);
    var socketPath1 = path.join(paths.readers, readerUuid + '.s');
    return cleanPipeName(socketPath1);
}
function socketInfoPath(channelName, readerUuid, paths) {
    paths = paths || getPaths(channelName);
    var socketPath2 = path.join(paths.readers, readerUuid + '.json');
    return socketPath2;
}
/**
...
function _countChannelFolders() {
    _countChannelFolders = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee7() {
        var folders;
 ...
 */ function _connectionError() {
    _connectionError = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee8(originalError) {
...
function _createSocketEventEmitter() {
    _createSocketEventEmitter = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee11(channelName, readerUuid, paths) {
                    ...
                    case 0:
                        ...
                        return new Promise(function(resolve, reject) {
                            server.on('error', /*#__PURE__*/ function() {
                                var _ref5 = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee9(err) {
                                    var useErr;
                            ...
                            server.listen(pathToSocket, /*#__PURE__*/ function() {
                                var _ref6 = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee10(err, res) {
                                    var useErr;
 ...
 */ function _openClientConnection() {
    _openClientConnection = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee12(channelName, readerUuid) {
...
function _getReadersUuids() {
    _getReadersUuids = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee13(channelName, paths) {
...
function _messagePath() {
    _messagePath = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee14(channelName, time, token, writerUuid) {
...
function _getAllMessages() {
    _getAllMessages = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee15(channelName, paths) {
...
function _cleanOldMessages() {
    _cleanOldMessages = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee16(messageObjects, ttl) {
        var olderThen;
...
function _create() {
    _create = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee17(channelName) {
        var options, time, paths, ensureFolderExistsPromise, uuid, state, _yield$Promise$all2, socketEE, infoFilePath, _args17 = arguments;
 ...
 */ function _handleMessagePing() {
    _handleMessagePing = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee18(state, msgObj1) {
            ...
            while(1){
                switch(_context18.prev = _context18.next){
                    ...
                    case 8:
                        // get single message
                        messages = [
                            getSingleMessage(state.channelName, msgObj1, state.paths)
                        ];
                    case 9:
...
function refreshReaderClients(channelState) {
    return getReadersUuids(channelState.channelName, channelState.paths).then(function(otherReaders) {
        ...
        Object.keys(channelState.otherReaderClients).filter(function(readerUuid) {
            ...
            var _ref = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee(readerUuid) {
        ...
        .map(/*#__PURE__*/ function() {
            var _ref2 = (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee2(readerUuid) {
                var client;
 ...
 */ function postMessage(channelState, messageJson) {
    ...
    channelState.writeBlockPromise = channelState.writeBlockPromise.then(/*#__PURE__*/ (0, _asyncToGenerator).default(/*#__PURE__*/ _regenerator.default.mark(function _callee3() {
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
             ...
             */ if (randomInt(0, 20) === 0) {
                            /* await */ getAllMessages(channelState.channelName, channelState.paths).then(function(allMessages) {
