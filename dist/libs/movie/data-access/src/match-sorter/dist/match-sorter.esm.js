 ...
 */ function matchSorter(items, value, options) {
    ...
    var matchedItems1 = items.reduce(reduceItemsToRanked, []);
    return sorter(matchedItems1).map(function(_ref) {
        var item = _ref.item;
        return item;
    });
    function reduceItemsToRanked(matches, item, index) {
        ...
        if (rank >= keyThreshold) {
            matches.push((0, _extends).default({}, rankingInfo, {
                item: item,
                index: index
            }));
        }
 ...
 */ function getKeyAttributes(key) {
    ...
    return (0, _extends).default({}, defaultKeyAttributes, key);
}

//# sourceMappingURL=match-sorter.esm.js.map