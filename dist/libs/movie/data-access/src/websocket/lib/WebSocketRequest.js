...
WebSocketRequest.prototype.parseExtensions = function(extensionsString) {
    ...
    extensions.forEach(function(extension, index1, array1) {
...
WebSocketRequest.prototype.accept = function(acceptedProtocol, allowedOrigin, cookies) {
    ...
    if (protocolFullCase) {
        // validate protocol
        for(var i1 = 0; i1 < protocolFullCase.length; i1++){
            var charCode = protocolFullCase.charCodeAt(i1);
            var character = protocolFullCase.charAt(i1);
