"use strict";
var assert = require("chai").assert, wait = require("timers-ext/promise/sleep"), limit = require("../../promise/limit").bind(Promise);
describe("promise/limit", function() {
    ...
    it("Should resolve with expected result", function() {
        ...
        limited();
        assert.equal(count, 2);
        return limited().then(function(result1) {
            assert.equal(result1, 3);
            limited().then(function(result) {
