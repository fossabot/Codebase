...
var QueryClient = /*#__PURE__*/ function() {
    ...
    var _proto = QueryClient1.prototype;
    ...
    _proto.isMutating = function isMutating(filters) {
        return this.mutationCache.findAll((0, _extends).default({}, filters, {
            fetching: true
        })).length;
    };
    ...
    _proto.resetQueries = function resetQueries(arg1, arg2, arg3) {
        ...
        var queryCache = this.queryCache;
        var refetchFilters = (0, _extends).default({}, filters, {
            active: true
        });
        return _notifyManager.notifyManager.batch(function() {
            queryCache.findAll(filters).forEach(function(query) {
    ...
    _proto.refetchQueries = function refetchQueries(arg1, arg2, arg3) {
        ...
        var promises = _notifyManager.notifyManager.batch(function() {
            return _this6.queryCache.findAll(filters).map(function(query) {
                return query.fetch(undefined, (0, _extends).default({}, options, {
                    meta: {
    ...
    _proto.defaultQueryOptions = function defaultQueryOptions(options) {
        ...
        var defaultedOptions = (0, _extends).default({}, this.defaultOptions.queries, this.getQueryDefaults(options == null ? void 0 : options.queryKey), options, {
            _defaulted: true
        });
    ...
    _proto.defaultMutationOptions = function defaultMutationOptions(options) {
        ...
        return (0, _extends).default({}, this.defaultOptions.mutations, this.getMutationDefaults(options == null ? void 0 : options.mutationKey), options, {
            _defaulted: true
        });
    };
