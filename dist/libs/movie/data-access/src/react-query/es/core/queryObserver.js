...
var QueryObserver = /*#__PURE__*/ function(_Subscribable) {
    (0, _inheritsLoose).default(QueryObserver1, _Subscribable);
    function QueryObserver1(client, options) {
        var _this;
    ...
    var _proto = QueryObserver1.prototype;
    ...
    _proto.refetch = function refetch(options) {
        return this.fetch((0, _extends).default({}, options, {
            meta: {
    ...
    _proto.updateResult = function updateResult(notifyOptions) {
        ...
        this.notify((0, _extends).default({}, defaultNotifyOptions, notifyOptions));
    };
