...
var Query = /*#__PURE__*/ function() {
    ...
    var _proto = Query1.prototype;
    _proto.setOptions = function setOptions(options) {
        var _this$options$cacheTi;
        this.options = (0, _extends).default({}, this.defaultOptions, options);
        ...
        switch(action.type){
            ...
            case 'error':
                ...
                if ((0, _retryer).isCancelledError(error) && error.revert && this.revertState) {
                    return (0, _extends).default({}, this.revertState);
                }
                return (0, _extends).default({}, state, {
                    error: error,
            ...
            case 'setState':
                return (0, _extends).default({}, state, action.state);
            default:
                return state;
        }
    };
