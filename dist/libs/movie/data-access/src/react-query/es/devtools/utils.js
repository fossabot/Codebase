...
function styled(type, newStyles, queries) {
    ...
    return(/*#__PURE__*/ _react.default.forwardRef(function(_ref, ref) {
        var style = _ref.style, rest = (0, _objectWithoutPropertiesLoose).default(_ref, [
            "style"
        ]);
        ...
        var mediaStyles = Object.entries(queries).reduce(function(current, _ref2) {
            ...
            return (0, _useMediaQuery).default(key) ? (0, _extends).default({}, current, typeof value === 'function' ? value(rest, theme) : value) : current;
        }, {});
        return(/*#__PURE__*/ _react.default.createElement(type, (0, _extends).default({}, rest, {
            style: (0, _extends).default({}, typeof newStyles === 'function' ? newStyles(rest, theme) : newStyles, style, mediaStyles),
            ref: ref
        })));
    }));
}
