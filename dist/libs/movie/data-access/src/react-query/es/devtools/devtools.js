...
var _utils1 = require("../core/utils");
...
function ReactQueryDevtools(_ref) {
    ...
    var _useLocalStorage1 = (0, _useLocalStorage).default('reactQueryDevtoolsOpen', initialIsOpen), isOpen = _useLocalStorage1[0], setIsOpen = _useLocalStorage1[1];
    var _useLocalStorage2 = (0, _useLocalStorage).default('reactQueryDevtoolsHeight', null), devtoolsHeight = _useLocalStorage2[0], setDevtoolsHeight = _useLocalStorage2[1];
    ...
    var _panelProps$style = panelProps.style, panelStyle = _panelProps$style === void 0 ? {} : _panelProps$style, otherPanelProps = (0, _objectWithoutPropertiesLoose).default(panelProps, [
        "style"
    ]);
    var _closeButtonProps$sty = closeButtonProps.style, closeButtonStyle = _closeButtonProps$sty === void 0 ? {} : _closeButtonProps$sty, onCloseClick = closeButtonProps.onClick, otherCloseButtonProps = (0, _objectWithoutPropertiesLoose).default(closeButtonProps, [
        "style",
        "onClick"
    ]);
    var _toggleButtonProps$st = toggleButtonProps.style, toggleButtonStyle = _toggleButtonProps$st === void 0 ? {} : _toggleButtonProps$st, onToggleClick = toggleButtonProps.onClick, otherToggleButtonProps = (0, _objectWithoutPropertiesLoose).default(toggleButtonProps, [
        "style",
        "onClick"
    ...
    }, /*#__PURE__*/ _react.default.createElement(ReactQueryDevtoolsPanel, (0, _extends).default({
        ref: panelRef
    }, otherPanelProps, {
    ...
    })), isResolvedOpen ? /*#__PURE__*/ _react.default.createElement(_styledComponents.Button, (0, _extends).default({
        type: "button",
    ...
    }), "Close") : null), !isResolvedOpen ? /*#__PURE__*/ _react.default.createElement("button", (0, _extends).default({
        type: "button"
...
var ReactQueryDevtoolsPanel = /*#__PURE__*/ _react.default.forwardRef(function ReactQueryDevtoolsPanel(props, ref) {
    ...
    var _props$isOpen = props.isOpen, isOpen = _props$isOpen === void 0 ? true : _props$isOpen, setIsOpen = props.setIsOpen, handleDragStart = props.handleDragStart, panelProps = (0, _objectWithoutPropertiesLoose).default(props, [
        "isOpen",
        "setIsOpen",
        "handleDragStart"
    ]);
    ...
    var _useLocalStorage3 = (0, _useLocalStorage).default('reactQueryDevtoolsSortFn', Object.keys(sortFns)[0]), sort = _useLocalStorage3[0], setSort = _useLocalStorage3[1];
    var _useLocalStorage4 = (0, _useLocalStorage).default('reactQueryDevtoolsFilter', ''), filter = _useLocalStorage4[0], setFilter = _useLocalStorage4[1];
    var _useLocalStorage5 = (0, _useLocalStorage).default('reactQueryDevtoolsSortDesc', false), sortDesc = _useLocalStorage5[0], setSortDesc = _useLocalStorage5[1];
    ...
    var _useLocalStorage6 = (0, _useLocalStorage).default('reactQueryDevtoolsActiveQueryHash', ''), activeQueryHash = _useLocalStorage6[0], setActiveQueryHash = _useLocalStorage6[1];
    ...
    var handleRefetch = function handleRefetch() {
        ...
        promise == null ? void 0 : promise.catch(_utils1.noop);
    };
    return(/*#__PURE__*/ _react.default.createElement(_theme.ThemeProvider, {
        theme: _theme.defaultTheme
    }, /*#__PURE__*/ _react.default.createElement(_styledComponents.Panel, (0, _extends).default({
        ref: ref,
