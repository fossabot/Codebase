...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react')) : typeof define === 'function' && define.amd ? define([
        'exports',
        'react'
    ], factory) : (global = global || self, factory(global.ReactQuery = {}, global.React));
    ...
    var Subscribable1 = /*#__PURE__*/ function() {
   ...
   */ function scheduleMicrotask(callback) {
    ...
    var FocusManager1 = /*#__PURE__*/ function(_Subscribable) {
    ...
    var focusManager = new FocusManager1();
    var OnlineManager1 = /*#__PURE__*/ function(_Subscribable) {
    ...
    var onlineManager = new OnlineManager1();
    ...
    var Retryer = function Retryer(config) {
        ...
        var run1 = function run() {
            ...
            try {
                ...
                promiseOrValue = Promise.reject(error1);
    ...
    // CLASS
    var NotifyManager1 = /*#__PURE__*/ function() {
    ...
    var notifyManager = new NotifyManager1();
    // TYPES
    // FUNCTIONS
    var logger = console;
    function getLogger() {
    ...
    // CLASS
    var QueryCache1 = /*#__PURE__*/ function(_Subscribable) {
    ...
    // CLASS
    var Mutation1 = /*#__PURE__*/ function() {
    ...
    // CLASS
    var MutationCache1 = /*#__PURE__*/ function(_Subscribable) {
        ...
        return {
            onFetch: function onFetch(context) {
                context.fetchFn = function() {
                    ...
                    var promise1; // Fetch first page?
                    if (!oldPages.length) {
                        promise1 = fetchPage([]);
                    } else if (isFetchingNextPage) {
                        var manual1 = typeof pageParam !== 'undefined';
                        var param1 = manual1 ? pageParam : getNextPageParam(context.options, oldPages);
                        promise1 = fetchPage(oldPages, manual1, param1);
                    } else if (isFetchingPreviousPage) {
                        var _manual = typeof pageParam !== 'undefined';
                        var _param = _manual ? pageParam : getPreviousPageParam(context.options, oldPages);
                        promise1 = fetchPage(oldPages, _manual, _param, true);
                    } else {
                        (function() {
                            newPageParams = [];
                            var manual = typeof context.options.getNextPageParam === 'undefined';
                            var shouldFetchFirstPage = refetchPage && oldPages[0] ? refetchPage(oldPages[0], 0, oldPages) : true; // Fetch first page
                            promise1 = shouldFetchFirstPage ? fetchPage([], manual, oldPageParams[0]) : Promise.resolve(buildNewPages([], oldPageParams[0], oldPages[0])); // Fetch remaining pages
                            var _loop = function _loop(i) {
                                promise1 = promise1.then(function(pages) {
                            ...
                            for(var i1 = 1; i1 < oldPages.length; i1++){
                                _loop(i1);
                            }
                        })();
                    }
                    var finalPromise = promise1.then(function(pages) {
                        return {
                            pages: pages,
   ...
   */ function hasPreviousPage(options, pages) {
    ...
    // CLASS
    var QueryClient1 = /*#__PURE__*/ function() {
        function QueryClient(config) {
            if (config === void 0) {
                config = {};
            }
            this.queryCache = config.queryCache || new QueryCache1();
            this.mutationCache = config.mutationCache || new MutationCache1();
            this.defaultOptions = config.defaultOptions || {};
            this.queryDefaults = [];
    ...
    var QueryObserver1 = /*#__PURE__*/ function(_Subscribable) {
    ...
    var QueriesObserver1 = /*#__PURE__*/ function(_Subscribable) {
        ...
        _proto.getObserver = function getObserver(options) {
            ...
            return currentObserver != null ? currentObserver : new QueryObserver1(this.client, defaultedOptions);
        };
    ...
    var InfiniteQueryObserver1 = /*#__PURE__*/ function(_QueryObserver) {
    ...
    // CLASS
    var MutationObserver1 = /*#__PURE__*/ function(_Subscribable) {
    ...
    function useMutation(arg1, arg2, arg3) {
        ...
        if (!obsRef.current) {
            obsRef.current = new MutationObserver1(queryClient, options);
        } else {
    ...
    function useQuery(arg1, arg2, arg3) {
        var parsedOptions = parseQueryArgs(arg1, arg2, arg3);
        return useBaseQuery(parsedOptions, QueryObserver1);
    }
    function useQueries(queries) {
        ...
        var _React$useState2 = React__default.useState(function() {
            return new QueriesObserver1(queryClient, defaultedQueries);
        }), observer = _React$useState2[0];
    ...
    function useInfiniteQuery(arg1, arg2, arg3) {
        ...
        return useBaseQuery(options, InfiniteQueryObserver1);
    }
    ...
    exports.InfiniteQueryObserver = InfiniteQueryObserver1;
    exports.MutationCache = MutationCache1;
    exports.MutationObserver = MutationObserver1;
    exports.QueriesObserver = QueriesObserver1;
    exports.QueryCache = QueryCache1;
    exports.QueryClient = QueryClient1;
    exports.QueryClientProvider = QueryClientProvider;
    exports.QueryErrorResetBoundary = QueryErrorResetBoundary;
    exports.QueryObserver = QueryObserver1;
