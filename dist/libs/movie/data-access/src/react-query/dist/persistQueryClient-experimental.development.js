...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-query')) : typeof define === 'function' && define.amd ? define([
        'exports',
        'react-query'
    ], factory) : (global = global || self, factory(global.ReactQueryPersistQueryClientExperimental = {}, global.ReactQuery));
})(void 0, function(exports, reactQuery) {
    'use strict';
    // TYPES
    // FUNCTIONS
    var logger = console;
    ...
    var persistQueryClient = _async(function(_ref) {
        var queryClient = _ref.queryClient, persistor = _ref.persistor, _ref$maxAge = _ref.maxAge, maxAge = _ref$maxAge === void 0 ? 1000 * 60 * 60 * 24 : _ref$maxAge, _ref$buster = _ref.buster, buster = _ref$buster === void 0 ? '' : _ref$buster, hydrateOptions = _ref.hydrateOptions, dehydrateOptions = _ref.dehydrateOptions;
