...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define([
        'exports'
    ], factory) : (global = global || self, factory(global.ReactQueryBroadcastQueryClientExperimental = {}));
  ...
  */ function postMessage$2(channelState, messageJson) {
   ...
   */ BroadcastChannel$1._pubkey = true;
    BroadcastChannel$1.prototype = {
        ...
        set onmessage (fn){
            var time1 = this.method.microSeconds();
            var listenObj = {
                time: time1,
                fn: fn
            };
    ...
    function broadcastQueryClient(_ref) {
        var queryClient = _ref.queryClient, _ref$broadcastChannel = _ref.broadcastChannel, broadcastChannel = _ref$broadcastChannel === void 0 ? 'react-query' : _ref$broadcastChannel;
        ...
        queryClient.getQueryCache().subscribe(function(queryEvent) {
            ...
            var _queryEvent$query = queryEvent.query, queryHash = _queryEvent$query.queryHash, queryKey = _queryEvent$query.queryKey, state = _queryEvent$query.state;
        ...
        channel.onmessage = function(action) {
            ...
            tx(function() {
                var type = action.type, queryHash = action.queryHash, queryKey = action.queryKey, state = action.state;
