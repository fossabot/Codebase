...
function _getDecoratorsApi() {
    ...
    var api = {
        ...
        toElementDescriptors: function toElementDescriptors(elementObjects) {
            ...
            return (0, _toArrayJs).default(elementObjects).map(function(elementObject) {
        ...
        toElementDescriptor: function toElementDescriptor(elementObject) {
            ...
            var key = (0, _toPropertyKeyJs).default(elementObject.key);
...
function _createElementDescriptor(def) {
    var key = (0, _toPropertyKeyJs).default(def.key);
    var descriptor;
    if (def.kind === "method") {
        descriptor = {
            value: def.value,
