...
let RealtimeSubscription = class RealtimeSubscription {
   ...
   */ onMessage(event, payload, ref) {
    ...
    trigger(event, payload, ref) {
        let { close , error , leave , join  } = _constants.CHANNEL_EVENTS;
        let events = [
            close,
            error,
            leave,
        ...
        this.bindings.filter((bind)=>{
            ...
            if (bind.event === '*') {
                return event === (payload == null ? void 0 : payload.type);
            } else {
    ...
    constructor(topic, params = {}, socket){
        ...
        this.rejoinTimer = new _timer.default(()=>this.rejoinUntilConnected()
